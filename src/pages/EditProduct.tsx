...
export default function EditService() {
    ...
    // barbero seleccionado — arranca con el que ya tiene el servicio
    const [selectedBarber, setSelectedBarber] = useState(service.barber ?? "")
    ...
    return (
        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }}
            ...
            <Form method="POST" className="flex flex-col gap-5">
                ...
                {/* BARBERO — tarjetas con foto, igual que NewService */}
                <div className="space-y-2">
                    ...
                    {/* ✅ hidden input con el barbero seleccionado */}
